...
const Subscription = () => {
    ...
    const addToCart = () => {
        setCart([...cart, { title: "Lucky Cat", imageSrc: "./images/white-cat.png" }]);
        setIsAdded(true);
    };
    const isInCart = cart.some(item => item.title === "Lucky Cat");
    useEffect(() => {
        window.scrollTo({
            top: 0,
            behavior: "auto",
        ...
        <div>
            ...
            <div className="cat-section">
                <div className="cat-div">
                    <img className="cat-img" src="./images/white-cat.png" alt="Lucky Cat" />
                </div>
                <div style={{ marginTop: "117px" }}>
                    <h1>Lucky Cat</h1>
                    <p>Our super limited edition Japanese lucky cat CableCritter. ONLY 10 available. Keep your cables safe from fraying!</p>
                    <hr />
