...
const Subscription = () => {
    ...
    const addToCart = () => {
        setCart([...cart, { title: "Turtle", imageSrc:" ./images/turtle.png" }]);
        setIsAdded(true);
    };
    const isInCart = cart.some(item => item.title === "Turtle");
        ...
        <div>
            ...
            <div className="cat-section">
                <div className="cat-div">
                    <img className="cat-img" src="./images/turtle.png" alt="Lucky Cat" />
                </div>
                <div style={{ marginTop: "117px" }}>
                    <h1>Turtle</h1>
                    <p>Turtle Silicone cable protector</p>
                    <hr />
                    <h3 style={{ fontSize: "25px" }}>A$ 3.00 AUD</h3>
                    <br />
                    <button
                        style={{
                            border: "2px solid",
