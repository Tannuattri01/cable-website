...
const Subscription = () => {
    ...
    const addToCart = () => {
        setCart([...cart, { title: "Shinchan", imageSrc: "./images/sinchan.png" }]);
        setIsAdded(true);
    };
    const isInCart = cart.some(item => item.title === "Shinchan");
        ...
        <div>
            ...
            <div className="cat-section">
                <div className="cat-div">
                    <img className="cat-img" src="./images/sinchan.png" alt="Lucky Cat" />
                </div>
