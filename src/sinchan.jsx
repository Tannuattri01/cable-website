...
const Subscription = () => {
    ...
    const addToCart = () => {
        setCart([...cart, { title: "Shinchan", imageSrc: "/sinchan.png" }]);
        setIsAdded(true);
    };
        ...
        <div>
            ...
            <div className='navitem' style={{ display: 'flex', justifyContent: 'space-between', color: 'black', flexWrap:"wrap" }}>
                ...
                {showCart && (
                    <div className="cart-dropdown" style={{
                        padding: '10px', width: '250px', position: 'absolute', top: '50px', right: '20px',
                        background: 'white', border: '1px solid #ccc', borderRadius: '8px', zIndex: 1000
                    }}>
                        <h3>Shopping Cart</h3>
            ...
            <div className="cat-section">
                <div className="cat-div">
                    <img className="cat-img" src="/sinchan.png" alt="Shinchan" />
                </div>
                <div style={{ marginTop: "117px" }}>
                    <h1>Shin</h1>
                    <p>Shin Style silicone cable protector</p>
                    <hr />
                    ...
                    <button
                        style={{
                            ...
                            cursor: isAdded ? "default" : "pointer", transition: "0.3s"
                        }}
                        onClick={addToCart}
                        disabled={isAdded}
                    >
