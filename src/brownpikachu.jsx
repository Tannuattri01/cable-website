...
const Subscription = () => {
    ...
    const addToCart = () => {
        setCart([...cart, { title: "Eevee", imageSrc: "/brown-pikachu.png" }]);
        setIsAdded(true);
    };

    const isInCart = cart.some(item => item.title === "Eevee");
        ...
        <div>
            ...
            <div className="cat-section">
                <div className="cat-div">
                    <img className="cat-img" src="/brown-pikachu.png" alt="Eevee" />
                </div>
                <div style={{ marginTop: "117px" }}>
                    <h1>Eevee</h1>
                    <p>Eevee silicone cable protector</p>
                    <hr />
                    ...
                    <button style={{
                        ...
                        transition: "0.3s"
                    }} onClick={addToCart} disabled={isAdded}>
