...
const Subscription = () => {
    ...
    const addToCart = () => {
        setCart([...cart, { title: "Avacado", imageSrc: "./images/green-kiwi.png" }]);
    };

    const isInCart = cart.some(item => item.title === "Avacado");
        ...
        <div>
            ...
            <div className="cat-section">
                <div className="cat-div">
                    <img className="cat-img" src="./images/green-kiwi.png" alt="Lucky Cat" />
                </div>
                <div style={{ marginTop: "117px" }}>
                    <h1>Avacado</h1>
                    <p>Avacado silicone cable protector</p>
                    <hr />
