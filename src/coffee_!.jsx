...
const Subscription = () => {
    ...
    const addToCart = () => {
        setCart([...cart, { title: "Coffee cup brown", imageSrc: "./images/brown-coffee.png"}]);
        setIsAdded(true);
    };
    const isInCart = cart.some(item => item.title === "coffee cup brown");
    useEffect(() => {
        window.scrollTo({
            top: 0,
            behavior: "auto",
        ...
        <div>
            ...
            <div className="cat-section">
                <div className="cat-div">
                    <img className="cat-img" src="./images/brown-coffee.png" alt="Lucky Cat" />
                </div>
                <div style={{ marginTop: "117px" }}>
                    <h1>Coffee cup brown</h1>
                    <p>Coffe cup brown silicone cable protector</p>
                    <hr />
                    <h3 style={{ fontSize: "25px" }}>A$ 3.20 AUD</h3>
                    <br />
                    <button
                        style={{
                            border: "2px solid",
