...
const Subscription = () => {
    ...
    const addToCart = () => {
        setCart([...cart, { title: "Doremon", imageSrc: "./images/doremon.png" }]);
        setIsAdded(true);
    };
    const isInCart = cart.some(item => item.title === "Cookie Monster");
        ...
        <div>
            ...
            <div className="cat-section">
                <div className="cat-div">
                    <img className="cat-img" src="./images/doremon.png" alt="Lucky Cat" />
                </div>
                <div style={{ marginTop: "117px" }}>
                    <h1>Doremon</h1>
                    <p>Doremon Style silicone cable protector. please note this Cable Critter is much larger than other critters</p>
                    <hr />
                    <h3 style={{ fontSize: "25px" }}>A$ 3.80 AUD</h3>
                    <br />
                    <button
                        style={{
                            border: "2px solid",
