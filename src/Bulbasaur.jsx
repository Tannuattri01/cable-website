...
const Subscription = () => {
    ...
    const addToCart = () => {
        setCart([...cart, { title: "Bulbasaur", imageSrc: "./iamges/blue.png" }]);
        setIsAdded(true);
    };
    const isInCart = cart.some(item => item.title === "Bulbasaur");
    useEffect(() => {
        window.scrollTo({
            top: 0,
            behavior: "auto",
        ...
        <div>
            ...
            <div className="cat-section">
                <div className="cat-div">
                    <img className="cat-img" src="./images/blue.png" alt="Lucky Cat" />
                </div>
                <div style={{ marginTop: "117px" }}>
                    <h1>Bulbasaur</h1>
                    <p>bulbasaur Style silicone cable protector</p>
                    <hr />
